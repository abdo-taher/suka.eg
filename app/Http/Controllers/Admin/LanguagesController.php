...
class LanguagesController extends Controller
{
    ...
    public function view(){
        ...
        return view('pages.admin.languages.view',compact('language'));
    }
    public function select($action){
        ...
        return view('pages.admin.languages.view',compact('dataBack'));
    }
    public function addForm(){
        return view('pages.admin.languages.add');
    }
    ...
    public function deletelanguage($id){
        $language = language::find($id);
            if(!$language){
                return view('pages.admin.languages.view',$id);
            }
            try{
